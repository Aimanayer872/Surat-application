...
class DashboardsController extends AppController
{
	...
	public function index()
	{
        ...
        $this->fetchTable('application');
		$applicationEntity = $this->fetchTable('application');
		$total_app = $applicationEntity ->find()->all()->count();
		$approved_app = $applicationEntity->find()->where(['approval_status'=>1])->count();
