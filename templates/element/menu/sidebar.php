        ...
        <ul class="list-unstyled components">
            ...
            <?php if ($this->Identity->isLoggedIn()) { ?>
                <li class="menu-item <?= $c_name == 'Users' && $a_name == 'profile' ? 'active' : '' ?>">
                 ...
                 <li class="menu-item <?= $c_name == 'application' && $a_name == 'index' ? 'active' : '' ?>">
                    <?= $this->Html->link(__('<i class="fa-solid fa-folder"></i> Application'), ['controller' => 'application', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                </li>
                ...
                <?php if ($this->Identity->isLoggedIn() && $this->Identity->get('user_group_id') == '1') { ?>
                    ...
                    <li class="menu-item <?= $c_name == 'application' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="fa-solid fa-folder"></i> Application <span class ="badge text-bg-warning ">'. $total_application_pending . '</span>'), ['prefix' => 'Admin', 'controller' => 'application', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>

                    <li class="menu-item <?= $c_name == 'faculties' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="fa-solid fa-school"></i> Faculties'), ['prefix' => 'Admin', 'controller' => 'faculties', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>

                      <li class="menu-item <?= $c_name == 'programs' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="fa-solid fa-graduation-cap"></i> Programs'), ['prefix' => 'Admin', 'controller' => 'programs', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                <?php } ?>
            <?php } ?>
        </ul>
