...
<div class="row">
    ...
    <div class="table-responsive">
        <table class="table">
                ...
                <tr>
                    <th><?= __('Status') ?></th>
                    <td><?= $faculty->status === null ? '' : $this->Number->format($faculty->status) ?></td>
                </tr>
                <tr>
                    <th><?= __('Created') ?></th>
            ...
            <div class="card-body text-body-secondary">
                ...
                <?php if (!empty($faculty->application)) : ?>
                <div class="table-responsive">
                    <table class="table">
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($faculty->application as $application) : ?>
                        <tr>
                            <td><?= h($application->id) ?></td>
                            <td><?= h($application->user_id) ?></td>
                            <td><?= h($application->program_id) ?></td>
