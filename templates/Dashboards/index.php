	...
	<div class="col-md-9 border-end">
		...
		<div class="collapse show" id="chartCollapse">
			<div class="row mb-4">
				...
				<div class="col-md-3 ps-5">
					<div class="faq" data-waffly-title="Total approval application" data-waffly-value="<?php echo $approval_app_percent; ?>%">
						<div class="title">Total Application approval</div>
